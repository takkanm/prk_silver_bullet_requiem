...
kbd.add_layer :default, %i[
  ...
  XXXXXXX   XXXXXXX ALT_LANG2 LOWER_NO KC_SPACE KC_SPACE  KC_ENTER KC_ENTER RAISE_NO CMD_LANG1   XXXXXXX   XXXXXXX
...
kbd.add_layer :raise, %i[
  ...
  CTL_ESC KC_LABK KC_LCBR   KC_LBRACKET KC_LPRN  KC_QUOTE   KC_MINUS KC_EQUAL     KC_LCBR     KC_RCBR KC_PIPE    KC_GRV
...
kbd.define_mode_key :ALT_LANG2,   [ :KC_LANG2,             :KC_LALT,                     120,              400 ]
kbd.define_mode_key :CMD_LANG1,   [ :KC_LANG1,             :KC_RGUI,                     120,              400 ]
